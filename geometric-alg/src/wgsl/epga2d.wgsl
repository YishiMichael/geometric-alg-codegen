...
fn scalar_dual(self: Scalar) -> Trivector {
    return Trivector {
        e012: self.s,
    };
}

fn vector_dual(self: Vector) -> Bivector {
    return Bivector {
        e01: self.e2,
        e20: -self.e1,
        e12: -self.e0,
...
fn bivector_dual(self: Bivector) -> Vector {
    return Vector {
        e0: self.e12,
        e1: self.e20,
        e2: -self.e01,
...
fn trivector_dual(self: Trivector) -> Scalar {
    return Scalar {
        s: -self.e012,
    };
}
...
fn oddmultivector_dual(self: OddMultivector) -> EvenMultivector {
    return EvenMultivector {
        s: -self.e012,
        e01: self.e2,
        e20: -self.e1,
...
fn evenmultivector_dual(self: EvenMultivector) -> OddMultivector {
    return OddMultivector {
        e0: self.e12,
        e1: self.e20,
        e2: -self.e01,
...
fn scalar_undual(self: Scalar) -> Trivector {
    return Trivector {
        e012: self.s,
    };
}

fn vector_undual(self: Vector) -> Bivector {
    return Bivector {
        e01: self.e2,
        e20: -self.e1,
        e12: -self.e0,
...
fn bivector_undual(self: Bivector) -> Vector {
    return Vector {
        e0: self.e12,
        e1: self.e20,
        e2: -self.e01,
...
fn trivector_undual(self: Trivector) -> Scalar {
    return Scalar {
        s: -self.e012,
    };
}
...
fn oddmultivector_undual(self: OddMultivector) -> EvenMultivector {
    return EvenMultivector {
        s: -self.e012,
        e01: self.e2,
        e20: -self.e1,
...
fn evenmultivector_undual(self: EvenMultivector) -> OddMultivector {
    return OddMultivector {
        e0: self.e12,
        e1: self.e20,
        e2: -self.e01,
...
fn vector_outer_product_trivector(self: Vector, other: Trivector) -> Null {
    return Null {
        _phantom: 0.0,
    };
}
...
fn trivector_outer_product_vector(self: Trivector, other: Vector) -> Null {
    return Null {
        _phantom: 0.0,
    };
}
...
fn scalar_regressive_product_trivector(self: Scalar, other: Trivector) -> Scalar {
    return Scalar {
        s: self.s * other.e012,
    };
}
...
fn vector_regressive_product_bivector(self: Vector, other: Bivector) -> Scalar {
    return Scalar {
...
fn bivector_regressive_product_vector(self: Bivector, other: Vector) -> Scalar {
    return Scalar {
...
fn trivector_regressive_product_scalar(self: Trivector, other: Scalar) -> Scalar {
    return Scalar {
        s: self.e012 * other.s,
    };
}
...
fn trivector_reject_vector(self: Trivector, other: Vector) -> Null {
    return Null {
        _phantom: 0.0,
    };
}
