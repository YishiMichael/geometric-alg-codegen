...
fn fourvector_normalized(self: FourVector) -> FourVector {
    return fourvector_div_f32(fourvector_reverse(self), fourvector_norm(self));
}
...
fn fourvector_normalize(self: ptr<function, FourVector>) {
    fourvector_div_assign_f32(fourvector_reverse(self), fourvector_norm(self));
}
...
fn fourvector_project_fourvector(self: FourVector, other: FourVector) -> FourVector {
    return FourVector {
        e0123: 0.0,
    };
}

fn fourvector_project_null(self: FourVector, other: Null) -> Null {
    return Null {
        _phantom: 0.0,
    };
}
...
fn fourvector_project_multivector(self: FourVector, other: Multivector) -> Multivector {
    return Multivector {
        s: 0.0,
        e0: 0.0,
        e1: 0.0,
...
fn fourvector_reject_null(self: FourVector, other: Null) -> Null {
    return Null {
        _phantom: 0.0,
    };
}
...
fn fourvector_reject_multivector(self: FourVector, other: Multivector) -> Multivector {
    return Multivector {
        s: 0.0,
