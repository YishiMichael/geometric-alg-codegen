...
impl Add<f32> for Trivector {
    type Output = Trivector;
    fn add(self, other: f32) -> Trivector {
        Trivector {
...
impl Add<f32> for FourVector {
    type Output = FourVector;
    fn add(self, other: f32) -> FourVector {
        FourVector {
...
impl Sub<f32> for Trivector {
    type Output = Trivector;
    fn sub(self, other: f32) -> Trivector {
        Trivector {
            e021: self.e021 - other,
            e013: self.e013 - other,
            e032: self.e032 - other,
...
impl Sub<f32> for FourVector {
    type Output = FourVector;
    fn sub(self, other: f32) -> FourVector {
        FourVector {
            e0123: self.e0123 - other,
        }
    }
...
impl Div<Trivector> for Trivector {
    type Output = Trivector;
    fn div(self, other: Trivector) -> Trivector {
        Trivector {
            e021: self.e021 / other.e021,
            e013: self.e013 / other.e013,
            e032: self.e032 / other.e032,
...
impl Div<FourVector> for FourVector {
    type Output = FourVector;
    fn div(self, other: FourVector) -> FourVector {
        FourVector {
            e0123: self.e0123 / other.e0123,
        }
    }
...
impl AddAssign<f32> for Trivector {
    fn add_assign(&mut self, other: f32) {
        self.e021 += other;
        self.e013 += other;
        self.e032 += other;
...
impl AddAssign<f32> for FourVector {
    fn add_assign(&mut self, other: f32) {
        self.e0123 += other;
    }
}
...
impl SubAssign<f32> for Trivector {
    fn sub_assign(&mut self, other: f32) {
        self.e021 -= other;
        self.e013 -= other;
        self.e032 -= other;
...
impl SubAssign<f32> for FourVector {
    fn sub_assign(&mut self, other: f32) {
        self.e0123 -= other;
    }
}
...
impl MulAssign<Trivector> for Trivector {
    fn mul_assign(&mut self, other: Trivector) {
        self.e021 *= other.e021;
        self.e013 *= other.e013;
        self.e032 *= other.e032;
        self.e123 *= other.e123;
...
impl MulAssign<FourVector> for FourVector {
    fn mul_assign(&mut self, other: FourVector) {
        self.e0123 *= other.e0123;
    }
}
...
impl DivAssign<Trivector> for Trivector {
    fn div_assign(&mut self, other: Trivector) {
        self.e021 /= other.e021;
        self.e013 /= other.e013;
        self.e032 /= other.e032;
        self.e123 /= other.e123;
...
impl DivAssign<FourVector> for FourVector {
    fn div_assign(&mut self, other: FourVector) {
        self.e0123 /= other.e0123;
    }
}
...
impl NormSquared for OddMultivector {
    type Output = f32;
    fn norm_squared(self) -> f32 {
        self.e1 * self.e1 + self.e2 * self.e2 + self.e3 * self.e3 + self.e123 * self.e123
    }
}
...
impl NormSquared for EvenMultivector {
    type Output = f32;
    fn norm_squared(self) -> f32 {
        self.s * self.s + self.e12 * self.e12 + self.e31 * self.e31 + self.e23 * self.e23
    }
}
...
impl NormSquared for Multivector {
    type Output = f32;
    fn norm_squared(self) -> f32 {
        self.s * self.s + self.e1 * self.e1 + self.e2 * self.e2 + self.e12 * self.e12 + self.e3 * self.e3 + self.e31 * self.e31 + self.e23 * self.e23 + self.e123 * self.e123
    }
}
...
impl Inverse for Trivector {
    type Output = Trivector;
    fn inverse(self) -> Trivector {
        self.reverse().div(self.norm_squared())
    }
}

impl Inverse for FourVector {
    type Output = FourVector;
    fn inverse(self) -> FourVector {
        self.reverse().div(self.norm_squared())
    }
}
