...
impl NormSquared for Bivector {
    type Output = f32;
    fn norm_squared(self) -> f32 {
        self.e01 * self.e01 + self.e20 * self.e20 + self.e12 * self.e12
    }
}
...
impl NormSquared for OddMultivector {
    type Output = f32;
    fn norm_squared(self) -> f32 {
        self.e0 * self.e0 + self.e1 * self.e1 + self.e2 * self.e2 + self.e012 * self.e012
    }
}
...
impl NormSquared for EvenMultivector {
    type Output = f32;
    fn norm_squared(self) -> f32 {
        self.s * self.s + self.e01 * self.e01 + self.e20 * self.e20 + self.e12 * self.e12
    }
}
...
impl ScalarProduct<Bivector> for Bivector {
    type Output = f32;
    fn scalar_product(self, other: Bivector) -> f32 {
        -self.e01 * other.e01 - self.e20 * other.e20 - self.e12 * other.e12
    }
}
...
impl ScalarProduct<OddMultivector> for OddMultivector {
    type Output = f32;
    fn scalar_product(self, other: OddMultivector) -> f32 {
        self.e0 * other.e0 + self.e1 * other.e1 + self.e2 * other.e2 - self.e012 * other.e012
    }
}
...
impl ScalarProduct<EvenMultivector> for EvenMultivector {
    type Output = f32;
    fn scalar_product(self, other: EvenMultivector) -> f32 {
        self.s * other.s - self.e01 * other.e01 - self.e20 * other.e20 - self.e12 * other.e12
    }
}
