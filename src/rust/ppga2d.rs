...
impl NormSquared for Multivector {
    ...
    fn norm_squared(self) -> f32 {
        let a = self;
        a.s * a.s + a.e1 * a.e1 + a.e2 * a.e2 + a.e12 * a.e12
    }
}
...
impl GeometricProduct<EvenMultivector> for Vector {
    ...
    fn geometric_product(self, b: EvenMultivector) -> OddMultivector {
        ...
        OddMultivector {
            ...
            e1: a.e1 * b.s - a.e2 * b.e12,
            e2: a.e1 * b.e12 + a.e2 * b.s,
            e012: a.e0 * b.e12 + a.e1 * b.e20 + a.e2 * b.e01,
        }
    }
}
...
impl GeometricProduct<Vector> for EvenMultivector {
    ...
    fn geometric_product(self, b: Vector) -> OddMultivector {
        ...
        OddMultivector {
            ...
            e1: a.s * b.e1 + a.e12 * b.e2,
            e2: a.s * b.e2 - a.e12 * b.e1,
            e012: a.e01 * b.e2 + a.e20 * b.e1 + a.e12 * b.e0,
        }
    }
}
...
impl LeftInnerProduct<Multivector> for Multivector {
    ...
    fn left_inner_product(self, b: Multivector) -> Multivector {
        ...
        Multivector {
            ...
            e1: a.s * b.e1 - a.e2 * b.e12,
            e2: a.s * b.e2 + a.e1 * b.e12,
...
impl RightInnerProduct<Multivector> for Multivector {
    ...
    fn right_inner_product(self, b: Multivector) -> Multivector {
        ...
        Multivector {
            ...
            e1: a.e1 * b.s + a.e12 * b.e2,
            e2: a.e2 * b.s - a.e12 * b.e1,
...
impl Commutator<Multivector> for Multivector {
    ...
    fn commutator(self, b: Multivector) -> Multivector {
        ...
        Multivector {
            ...
            e1: -a.e2 * b.e12 + a.e12 * b.e2,
            e2: a.e1 * b.e12 - a.e12 * b.e1,
...
impl Transform<Multivector> for Scalar {
    ...
    fn transform(self, b: Multivector) -> Scalar {
        let a = self;
        Scalar {
            s: a.s * b.s * b.s - a.s * b.e1 * b.e1 - a.s * b.e2 * b.e2 + a.s * b.e12 * b.e12,
        }
    }
}
...
impl Transform<Vector> for Vector {
    ...
    fn transform(self, b: Vector) -> Vector {
        let a = self;
        Vector {
            e0: -a.e0 * b.e1 * b.e1 - a.e0 * b.e2 * b.e2 + 2.0 * a.e1 * b.e0 * b.e1 + 2.0 * a.e2 * b.e0 * b.e2,
            e1: a.e1 * b.e1 * b.e1 - a.e1 * b.e2 * b.e2 + 2.0 * a.e2 * b.e1 * b.e2,
            e2: 2.0 * a.e1 * b.e1 * b.e2 - a.e2 * b.e1 * b.e1 + a.e2 * b.e2 * b.e2,
        }
    }
}
...
impl Transform<Bivector> for Vector {
    ...
    fn transform(self, b: Bivector) -> Vector {
        let a = self;
        Vector {
            e0: -a.e0 * b.e12 * b.e12 - 2.0 * a.e1 * b.e20 * b.e12 - 2.0 * a.e2 * b.e01 * b.e12,
            e1: a.e1 * b.e12 * b.e12,
            e2: a.e2 * b.e12 * b.e12,
        }
    }
...
impl Transform<OddMultivector> for Vector {
    ...
    fn transform(self, b: OddMultivector) -> Vector {
        let a = self;
        Vector {
            e0: -a.e0 * b.e1 * b.e1 - a.e0 * b.e2 * b.e2 + 2.0 * a.e1 * b.e0 * b.e1 - 2.0 * a.e1 * b.e2 * b.e012 + 2.0 * a.e2 * b.e0 * b.e2 + 2.0 * a.e2 * b.e1 * b.e012,
            e1: a.e1 * b.e1 * b.e1 - a.e1 * b.e2 * b.e2 + 2.0 * a.e2 * b.e1 * b.e2,
            e2: 2.0 * a.e1 * b.e1 * b.e2 - a.e2 * b.e1 * b.e1 + a.e2 * b.e2 * b.e2,
        }
    }
...
impl Transform<EvenMultivector> for Vector {
    ...
    fn transform(self, b: EvenMultivector) -> Vector {
        let a = self;
        Vector {
            e0: -a.e0 * b.s * b.s - a.e0 * b.e12 * b.e12 - 2.0 * a.e1 * b.s * b.e01 - 2.0 * a.e1 * b.e20 * b.e12 + 2.0 * a.e2 * b.s * b.e20 - 2.0 * a.e2 * b.e01 * b.e12,
            e1: -a.e1 * b.s * b.s + a.e1 * b.e12 * b.e12 - 2.0 * a.e2 * b.s * b.e12,
            e2: 2.0 * a.e1 * b.s * b.e12 - a.e2 * b.s * b.s + a.e2 * b.e12 * b.e12,
        }
    }
}
...
impl Transform<Multivector> for Vector {
    ...
    fn transform(self, b: Multivector) -> Vector {
        let a = self;
        Vector {
            e0: -a.e0 * b.s * b.s - a.e0 * b.e1 * b.e1 - a.e0 * b.e2 * b.e2 - a.e0 * b.e12 * b.e12 - 2.0 * a.e1 * b.s * b.e01 + 2.0 * a.e1 * b.e0 * b.e1 - 2.0 * a.e1 * b.e2 * b.e012 - 2.0 * a.e1 * b.e20 * b.e12 + 2.0 * a.e2 * b.s * b.e20 + 2.0 * a.e2 * b.e0 * b.e2 + 2.0 * a.e2 * b.e1 * b.e012 - 2.0 * a.e2 * b.e01 * b.e12,
            e1: -a.e1 * b.s * b.s + a.e1 * b.e1 * b.e1 - a.e1 * b.e2 * b.e2 + a.e1 * b.e12 * b.e12 - 2.0 * a.e2 * b.s * b.e12 + 2.0 * a.e2 * b.e1 * b.e2,
            e2: 2.0 * a.e1 * b.s * b.e12 + 2.0 * a.e1 * b.e1 * b.e2 - a.e2 * b.s * b.s - a.e2 * b.e1 * b.e1 + a.e2 * b.e2 * b.e2 + a.e2 * b.e12 * b.e12,
        }
    }
}
...
impl Transform<Vector> for Bivector {
    ...
    fn transform(self, b: Vector) -> Bivector {
        let a = self;
        Bivector {
            e01: a.e01 * b.e1 * b.e1 - a.e01 * b.e2 * b.e2 - 2.0 * a.e20 * b.e1 * b.e2 - 2.0 * a.e12 * b.e0 * b.e2,
            e20: -2.0 * a.e01 * b.e1 * b.e2 - a.e20 * b.e1 * b.e1 + a.e20 * b.e2 * b.e2 - 2.0 * a.e12 * b.e0 * b.e1,
            e12: a.e12 * b.e1 * b.e1 + a.e12 * b.e2 * b.e2,
        }
    }
}
...
impl Transform<Bivector> for Bivector {
    ...
    fn transform(self, b: Bivector) -> Bivector {
        let a = self;
        Bivector {
            e01: -a.e01 * b.e12 * b.e12 + 2.0 * a.e12 * b.e01 * b.e12,
            e20: -a.e20 * b.e12 * b.e12 + 2.0 * a.e12 * b.e20 * b.e12,
            e12: a.e12 * b.e12 * b.e12,
        }
    }
}
...
impl Transform<OddMultivector> for Bivector {
    ...
    fn transform(self, b: OddMultivector) -> Bivector {
        let a = self;
        Bivector {
            e01: a.e01 * b.e1 * b.e1 - a.e01 * b.e2 * b.e2 - 2.0 * a.e20 * b.e1 * b.e2 - 2.0 * a.e12 * b.e0 * b.e2 + 2.0 * a.e12 * b.e1 * b.e012,
            e20: -2.0 * a.e01 * b.e1 * b.e2 - a.e20 * b.e1 * b.e1 + a.e20 * b.e2 * b.e2 - 2.0 * a.e12 * b.e0 * b.e1 - 2.0 * a.e12 * b.e2 * b.e012,
            e12: a.e12 * b.e1 * b.e1 + a.e12 * b.e2 * b.e2,
        }
    }
}
...
impl Transform<EvenMultivector> for Bivector {
    ...
    fn transform(self, b: EvenMultivector) -> Bivector {
        let a = self;
        Bivector {
            e01: a.e01 * b.s * b.s - a.e01 * b.e12 * b.e12 - 2.0 * a.e20 * b.s * b.e12 + 2.0 * a.e12 * b.s * b.e20 + 2.0 * a.e12 * b.e01 * b.e12,
            e20: 2.0 * a.e01 * b.s * b.e12 + a.e20 * b.s * b.s - a.e20 * b.e12 * b.e12 - 2.0 * a.e12 * b.s * b.e01 + 2.0 * a.e12 * b.e20 * b.e12,
            e12: a.e12 * b.s * b.s + a.e12 * b.e12 * b.e12,
        }
    }
}
...
impl Transform<Multivector> for Bivector {
    ...
    fn transform(self, b: Multivector) -> Bivector {
        let a = self;
        Bivector {
            e01: a.e01 * b.s * b.s + a.e01 * b.e1 * b.e1 - a.e01 * b.e2 * b.e2 - a.e01 * b.e12 * b.e12 - 2.0 * a.e20 * b.s * b.e12 - 2.0 * a.e20 * b.e1 * b.e2 + 2.0 * a.e12 * b.s * b.e20 - 2.0 * a.e12 * b.e0 * b.e2 + 2.0 * a.e12 * b.e1 * b.e012 + 2.0 * a.e12 * b.e01 * b.e12,
            e20: 2.0 * a.e01 * b.s * b.e12 - 2.0 * a.e01 * b.e1 * b.e2 + a.e20 * b.s * b.s - a.e20 * b.e1 * b.e1 + a.e20 * b.e2 * b.e2 - a.e20 * b.e12 * b.e12 - 2.0 * a.e12 * b.s * b.e01 - 2.0 * a.e12 * b.e0 * b.e1 - 2.0 * a.e12 * b.e2 * b.e012 + 2.0 * a.e12 * b.e20 * b.e12,
            e12: a.e12 * b.s * b.s + a.e12 * b.e1 * b.e1 + a.e12 * b.e2 * b.e2 + a.e12 * b.e12 * b.e12,
        }
    }
}
...
impl Transform<Vector> for Trivector {
    ...
    fn transform(self, b: Vector) -> Trivector {
        let a = self;
        Trivector {
            e012: a.e012 * b.e1 * b.e1 + a.e012 * b.e2 * b.e2,
        }
    }
}
...
impl Transform<EvenMultivector> for Trivector {
    ...
    fn transform(self, b: EvenMultivector) -> Trivector {
        let a = self;
        Trivector {
            e012: -a.e012 * b.s * b.s - a.e012 * b.e12 * b.e12,
        }
    }
}
...
impl Transform<Multivector> for Trivector {
    ...
    fn transform(self, b: Multivector) -> Trivector {
        let a = self;
        Trivector {
            e012: -a.e012 * b.s * b.s + a.e012 * b.e1 * b.e1 + a.e012 * b.e2 * b.e2 - a.e012 * b.e12 * b.e12,
        }
    }
}
...
impl Project<Vector> for Vector {
    ...
    fn project(self, b: Vector) -> Vector {
        let a = self;
        Vector {
            e0: a.e1 * b.e0 * b.e1 + a.e2 * b.e0 * b.e2,
            e1: a.e1 * b.e1 * b.e1 + a.e2 * b.e1 * b.e2,
            e2: a.e1 * b.e1 * b.e2 + a.e2 * b.e2 * b.e2,
        }
    }
}
...
impl Project<Bivector> for Vector {
    ...
    fn project(self, b: Bivector) -> Vector {
        let a = self;
        Vector {
            e0: -a.e1 * b.e20 * b.e12 - a.e2 * b.e01 * b.e12,
            e1: a.e1 * b.e12 * b.e12,
            e2: a.e2 * b.e12 * b.e12,
        }
    }
...
impl Project<Multivector> for Vector {
    ...
    fn project(self, b: Multivector) -> Vector {
        let a = self;
        Vector {
            e0: a.e1 * b.e0 * b.e1 - a.e1 * b.e20 * b.e12 + a.e2 * b.e0 * b.e2 - a.e2 * b.e01 * b.e12,
            e1: a.e1 * b.e1 * b.e1 + a.e1 * b.e12 * b.e12 + a.e2 * b.e1 * b.e2,
            e2: a.e1 * b.e1 * b.e2 + a.e2 * b.e2 * b.e2 + a.e2 * b.e12 * b.e12,
        }
    }
}
...
impl Project<Bivector> for Bivector {
    ...
    fn project(self, b: Bivector) -> Bivector {
        let a = self;
        Bivector {
            e01: a.e12 * b.e01 * b.e12,
            e20: a.e12 * b.e20 * b.e12,
            e12: a.e12 * b.e12 * b.e12,
        }
    }
}
...
impl Reject<Vector> for Vector {
    ...
    fn reject(self, b: Vector) -> Vector {
        ...
        Vector {
            ...
            e1: a.e1 * b.e2 * b.e2 - a.e2 * b.e1 * b.e2,
            e2: -a.e1 * b.e1 * b.e2 + a.e2 * b.e1 * b.e1,
        }
    }
}
...
impl Reject<Multivector> for Vector {
    ...
    fn reject(self, b: Multivector) -> Vector {
        ...
        Vector {
            ...
            e1: a.e1 * b.s * b.s + a.e1 * b.e2 * b.e2 - a.e2 * b.e1 * b.e2,
            e2: -a.e1 * b.e1 * b.e2 + a.e2 * b.s * b.s + a.e2 * b.e1 * b.e1,
        }
    }
}
